...
class ScreenshotTool:
    ...
    def __init__(self, root):
        ...
        self.settings = {
            ...
            "window_state": {}  # To store other UI state
        }
    ...
    def save_ui_state(self):
        """Save current UI state before switching screens"""
    ...
    def restore_ui_state(self):
        """Restore UI state when returning to main screen"""
        if hasattr(self, 'folder_entry'):
    ...
    def update_preview(self, image):
        ...
        max_width = 380  # Slightly less than window width
        max_height = 300  # Reasonable preview height
    ...
    def return_to_main(self):
        ...
        # Recreate main GUI and restore state
        self.create_main_gui()
    ...
    def start_area_selection(self):
        ...
        self.save_ui_state()  # Save current state before hiding window
        self.root.withdraw()
    ...
    def take_screenshot(self):
        ...
        self.save_ui_state()  # Save current state before taking screenshot
        ...
        try:
            ...
            # Update preview and show notification
            self.root.deiconify()
...
if __name__ == "__main__":
    ...
    window_width = 400
    window_height = 500  # Increased height to accommodate preview
